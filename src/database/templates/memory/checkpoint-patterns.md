...
async function saveCheckpoint(outputDir: string, checkpoint: AgentCheckpoint): Promise<string> {
...
```typescript
async function restoreLatestCheckpoint(outputDir: string): Promise<AgentCheckpoint | null> {
...
async function createHandoff(outputDir: string, handoff: SessionHandoff): Promise<void> {
...
async function accumulateLearning(outputDir: string, learning: LearnedPattern): Promise<void> {
